...
- **Automated Web Scraping**: performs daily data collection directly from the [**CEPEA (Center for Advanced Studies on Applied Economics)**](https://www.cepea.org.br/br) website, even without API support, using Requests(Python) to interact with the website interface and obtain updated spreadsheets with input prices.
